		...
		<view class="home-more">
			<view class="home-more-top">
				...
				<view class="more-top-right">
					...
					<view class="more-top-img">
						<image src="../../../../static/images/more1.png" mode="aspectFill"></image>
					</view>
				</view>
			</view>
			<view class="home-more-bottom">
				<view class="more-card-box" v-for=" item in 4">
					<view class="more-card" >
						<view class="card-top">
							...
							<view class="card-top-info">
								<view class="top-info-max">
									VIP2
								</view>
								<view class="top-info-mini">
									500.00USD
								</view>
							</view>
						</view>
						<view class="card-top-text">
							Profit per transaction 0.60%  tasks contains 45 each order
						</view>
					</view>
				</view>
			</view>
...
<style lang="scss" scoped>
	...
	.home {
		...
		.home-video {
			...
			position: relative;
			.home-notice {
				box-shadow: 4px 4px 8px rgba(0, 0, 0, 0.1); /* 水平偏移量 垂直偏移量 模糊半径 颜色 */
				overflow: hidden;
				border-radius: 16px;
				left: 50%;
				bottom: -40rpx;
		...
		.product {
			...
			.product-item {
				...
				.item-box {
					...
					box-shadow: 0 0 10px rgba(0, 0, 0, 0.1); /* 水平偏移量 垂直偏移量 模糊半径 颜色 */
					border-radius: 16rpx;
					.item-img {
						width: 70rpx;
						height: 70rpx;
